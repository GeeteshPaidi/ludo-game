...
//bringing the dice button element and all piece elements
...
export class UI {
    static listenDiceClick(callback) {
        diceButtonElement.addEventListener('click', callback);  //callback is a function that is passed as an argument to another function
    }
    ...
    static setPiecePosition(player, piece, newPosition) {
        ...
        //incrementing the position of the piece by given values , co-ords , dice value amd srep-length
